...
progresso_file = "progress_cnes.txt"
...
for Grupo in Grupos:
    try:
        ...
        local_dir = os.path.expanduser(os.path.join("/parquet_files/cnes", Grupo))
        ...
        files = cnes.get_files([Grupo], uf=estados, year=anos)
        ...
        if arquivos_para_download:
            ...
            for file in arquivos_para_download:
                try:
                    ...
                    cnes.download([file], local_dir=local_dir)
